        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    {{ __('Form ubah kategori artikel') }}
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('backend.article.category.update', $articleCategory) }}" method="POST">
                    @csrf
                    @method('PUT')
...
<div class="modal fade" id="modalDelete" tabindex="-1" aria-labelledby="modalDeleteLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('backend.article.category.destroy', $articleCategory) }}" method="POST">
                @csrf
                @method('DELETE')
                <div class="modal-body">
                    <div class="alert alert-danger">
                        {{ __('Anda yakin menghapus kategori ini? Semua artikel dengan kategori ini akan ikut terhapus') }}
                    </div>
                </div>
